...
(() => {
          ...
          if (typeof v === "string" && v.trim()) {
            ...
            v = function(evt) {
              try {
                ...
                console.error("Error executing handler for " + k + ":", err);
              }
            };
  ...
  // src/cdn.ts
  var REACT_URL = "/shared/vendor/react.production.min.js";
  var REACT_SRI = "";
  var REACT_DOM_URL = "/shared/vendor/react-dom.production.min.js";
  var REACT_DOM_SRI = "";
  var BABEL_URL = "/shared/vendor/babel.min.js";
  var BABEL_SRI = "";
  function cdnScriptFor(url, sri) {
    const res = window.__resources;
    const v = res ? res[url] : void 0;
    return typeof v === "string" && v ? { src: v } : (sri ? { src: url, integrity: sri } : { src: url });
  }
